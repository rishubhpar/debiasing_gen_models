...
class UNet2DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        Args:
            ...
            scaling_strength (`int`, *optional* , defaults to 1): The guidance strength of the classifier
            loss_strength (`int`, *optional* , defaults to 1): Same as `scaling_strength` but has a higher effect
            checkpoint_path (`str`, *optional*, defaults to active workspace path: Path to the classifier checkpoint)
            mode (`str`, *optional*, defaults to 'distribution'): Whether to apply sample-based or distribution-based guidance
